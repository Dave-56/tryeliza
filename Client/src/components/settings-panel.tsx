...
export function SettingsPanel() {
  ...
  //       // Show toast with reconnect button if Gmail session expired
  ...
  //               <span>Please reconnect your Gmail account</span>
  //               <Button 
  //                 variant="outline" 
  //                 size="sm"
  //                 className="mt-2"
  ...
  //       toast({
  //         variant: "destructive",
  //         description: errorData.msg || "Please log in to sync emails",
  //       });
  //       return;
  //     }
  ...
  //     toast({
  //       description: `Successfully synced ${result.synced} emails`,
  //     });
